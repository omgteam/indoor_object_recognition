...
if __name__ == '__main__':
    ...
    layer0 = LeNetConvPoolLayer(rng, input=layer0_input,
            ...
            filter_shape=(nkerns[0], 3, 127, 127), poolsize=(2, 2))

    # shape (batch_size,num_pixels) (i.e matrix of rasterized images)
    layer1_input = layer0.output.flatten(2)

    # construct a fully-connected sigmoidal layer
    layer1 = HiddenLayer(rng, input=layer1_input, n_in=nkerns[0] * 12 * 12,
                         n_out=50, activation=T.tanh)

    # classify the values of the fully-connected sigmoidal layer
    layer2 = LogisticRegression(input=layer1.output, n_in=50, n_out=4)
        ...
        for minibatch_index in xrange(n_train_batches):
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                if this_validation_loss < best_validation_loss:
                    best_params = layer2.params + layer1.params + layer0.params
